...
exports.ownerOnly = () => {
    return `❎ Perintah Ini Hanya Bisa Digunakan Oleh Bang Alif `
}
...
exports.botNotAdmin = () => {
    return `🤣Awokawok Gak Bisa Makanya Jadikan Gw Admin Agar Fiturnya Dapat Di Gunakan !`
}
...
saya Sad-Bot-Z-Md, bot ini adalah Beta Multi-Device Whatsapp. 
...
├ ZeeoneOfc
├ Penyedia Module
├ Kawan² The Mars Knowled Ft Pmeme
╰❒ And All Support
    `
}
...
Arigatou Gozaimasu! Untuk kalian user ramah dan Beberapa orang yg ikut membantu juga dalam project pembuatan Sad-Bot-Z-Md
😖🙏
`
}
exports.welcome = () =>{
...
exports.leave = () =>{
	return`Yah kok out 😣 Mental aman kan kak >.<? Gak aman, Pantes keluar
Goodbye`
}
exports.source = () =>{
return`*------「 SOURCE CODE 」 ------*
...
Hai Om/Tante ☺️ 
Donasi kak ? Jangan mencet doang atuh 😔
Donasi juga biar bot ini semakin di depan biar Yamaha kalah
